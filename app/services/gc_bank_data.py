...
class GoCardlessBankDataClient:
    def __init__(self, secret_id=SECRET_ID, secret_key=SECRET_KEY, token_refresh_buffer=60):
    ...
    def ensure_valid_token(self):
        ...
        if not self.access_token or now >= (self.token_expires - self.token_refresh_buffer):
    ...
    def create_agreement(self, institution_id, max_historical_days=90, access_valid_for_days=90, access_scope=None):
    ...
    def create_requisition(self, redirect_url, institution_id, reference=None, agreement_id=None, user_language="EN"):
    ...
    def get_account_transactions_paginated(self, account_id, date_from=None, date_to=None, limit=100, offset=0):
        """
    ...
    def get_all_account_transactions(self, account_id, date_from=None, date_to=None, batch_size=100):
        """
    ...
    def get_token_status(self):
        ...
        return {
            ...
            "current_time": now,
            "is_access_valid": self.access_token is not None and now < self.token_expires,
            "is_refresh_valid": self.refresh_token is not None and now < self.refresh_expires
        }
